					...
					<div class="container">
						...
						<div id="navbar-responsive-collapse" class="collapse navbar-collapse">
							<ul id="menu-menu-1" class="nav navbar-nav">
								<li class="<?=($this->uri->segment(1)==='home' || null === $this->uri->segment(1))?'active':''?>"><a href="<?php echo base_url('home'); ?>" >Home</a></li>
								<li class="<?=($this->uri->segment(1)==='code')?'active':''?>"><a href="<?php echo base_url('code'); ?>" >Code</a></li>
								<li class="<?=($this->uri->segment(1)==='tutorials')?'active':''?>"><a href="<?php echo base_url('tutorials'); ?>" >Tutorials</a></li>
